...
var AllService = /** @class */ (function () {
    ...
    AllService.prototype.getHistory = function (cid) {
        return this.http.get('https://api.javtix.me/api/purchase-history/' + cid).map(function (res) { return res.json(); });
    };
    AllService.prototype.getSeatMovie = function (tid) {
        return this.http.get('https://api.javtix.me/api/seatmovie-history/' + tid).map(function (res) { return res.json(); });
    };
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.showPurchases = function () {
        var _this = this;
        this.service.getHistory(localStorage.getItem('id')).subscribe(function (res) {
            _this.historyInfo = res;
            console.log(_this.historyInfo);
        }, function (err) { return console.log(err.error); });
    };
